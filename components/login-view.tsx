...
import { ShieldCheck, Mail, Lock, LogIn, AlertCircle, Eye, EyeOff } from "lucide-react"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-white/10 bg-[#111827] pl-9 pr-11 py-2.5 text-sm text-white placeholder-gray-500 focus:border-[#3B82F6] focus:outline-none"
              />
              <button
                type="button"
                ...
                className="absolute right-2 top-1/2 flex size-8 -translate-y-1/2 items-center justify-center rounded-lg text-gray-400 transition-colors hover:bg-white/10 hover:text-white"
              >
